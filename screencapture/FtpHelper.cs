...
namespace screencapture
{
    public class FTPHelper
    {
        ...
        /// <returns></returns>  
        public FtpWebResponse Open(Uri uri, string ftpMethod)
        {
        ...
        public void GotoDirectory(string DirectoryName, bool IsRoot)
        {
            ...
            ftpURI =new Uri( "ftp://" + ftpServerIP + "/" + ftpRemotePath + "/");
        }
     ...
     */
        public void RemoveDirectory(string remoteDirectoryName)
        {
            ...
            GotoDirectory(remoteDirectoryName, true);
            response = Open(ftpURI, WebRequestMethods.Ftp.RemoveDirectory);
        }
        ...
        public List<FileStruct> ListFilesAndDirectories()
        {
            ...
            response = Open(ftpURI, WebRequestMethods.Ftp.ListDirectoryDetails);
