...
namespace screencapture
{
    public class XMLHelper
    {
        ...
        public static List<XmlAttribute> GetXmlAttributes(string xmlFileName, string xpath, string xmlAttributeName)
        {
            string content = string.Empty;
            XmlDocument xmlDoc = new XmlDocument();
            // XmlAttribute xmlAttribute = null;
            ...
            try
            {
                ...
                {
                    XmlAttribute xmlAttribute = list[i].Attributes[xmlAttributeName];
        ...
        public static bool CreateXmlDocument(string xmlFileName, string rootNodeName, string version, string encoding, string standalone)
        {
            ...
            catch (Exception ex)
            {
                ...
                //LogWriter log = new LogWriter(str + "\\ERROR");
                //log.Logerrorset(ex.ToString());
                //System.Windows.Forms.MessageBox.Show("路径中含有非法字符！");
                throw ex;
            }
            return isSuccess;
        }
